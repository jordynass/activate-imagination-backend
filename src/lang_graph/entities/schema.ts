...
export const ItemSchema = z.object({
  ...
  fantasy: z.string().describe("An object in the fantasy world that resembles the real object in form or function"),
});

export const SettingSchema = z.object({
  id: z.number().describe('A unique integer ID'),
  setting: z.string().describe('A physical description of the fantasy setting of persistent \
...
export const SceneSchema = z.object({
  ...
  characters: z.array(CharacterSchema).describe(
    'A list of sentient characters in the scene'),
